...
Check it out deployed [here](https://vanguard-compare.onrender.com).
...
If you use [`uv`](https://docs.astral.sh/uv/) as a faster alternative to pip, you can clone the repo and run:
